...
import com.waxd.camera.capturer.deleteStalePendingRecordings
...
class App : Application() {
    ...
    override fun onCreate() {
        ...
        // Material You dynamic color is intentionally not applied here: the waxd
        // palette in themes.xml (colorPrimary/colorSecondary/colorSurface etc.)
        // is meant to be the fixed brand look, not replaced by system wallpaper colors.
